...
const renderStats = (menAlive, stres) => {
	alive = menAlive;
	stress = stres;
	statsDiv.innerHTML = `Alive: ${menAlive}, Stress: ${stress}`;
}
...
let story = [
	{ type: "cutscene", body: "Everything in quotes is cited from the Odyssey..." },
	...
	{ type: "cutscene", body: "The cyclops then comes back, throwing logs down the cave, startling everyone!", stress: 300 },
	...
	{ type: "cutscene", body: "you \"scuttled in panic into the deepest dark recess\"", stress: 400 },
	...
	{ type: "cutscene", body: "The cyclops lights a fire, illuminating the entire cave! The cyclops notices you and your crew.", stress: 200 },
	...
	{ type: "cutscene", body: "As soon as you say that, the cyclop snatches two of your men.", stress: 9000 },
	{ type: "cutscene", body: "Crew: AAAAAAA!" },
	{ type: "cutscene", body: "The cyclops devours them, \"Ripping them limb from limb to fix his meal.\"", alive: 8 },
	{ type: "cutscene", body: "The cyclops then leaves the cave...", stress: 100 },
	...
	{ type: "specific", requirements: [10], body: "The cyclops grabs another two of your men and devours them.", alive: 6 },
	...
	{ type: "specific", requirements: [12], body: "You and your crew attempt to run. The cyclop snatches 3 men and rips their heads off. The remaining men run even faster.", alive: 3 },
	...
	{ type: "specific", requirements: [13], body: "You and your crew quickly scurry.", stress: 200 },
	...
	{ type: "cutscene", body: "Your ship then departs away from the Cyclop's island.", stress: 20 },
	...
	{ type: "cutscene", body: "Your crew begs you to stop taunting, but you continue to taunt.", stress: 50 },
...
const generateScene = () => {
	...
	if (sceneData.alive) {
		renderStats(sceneData.alive, stress);
	}

	if (sceneData.stress) {
		renderStats(alive, sceneData.stress);
	}
}
